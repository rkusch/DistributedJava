...
<% Product validatedProduct = (Product) request.getAttribute("validatedProduct");
    if (validatedProduct != null) {
        ...
        if (cartTotal == null) {
            cartTotalAmount = validatedProduct.getPrice() * Double.valueOf(currentQty) ;
        } else {
            cartTotalAmount = Double.valueOf(cartTotal) + (validatedProduct.getPrice()* Double.valueOf(currentQty));
        }
