...
@EnableJpaRepositories(basePackages = "edu.wctc.dj.week6.RGK-Store-JPA")
public class PersistenceJNDIConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory()
		...
		emf.setPackagesToScan("edu.wctc.dj.week6.RGK-Store-JPA");
		emf.setPersistenceUnitName("AdventureWorks-pu");
	...
	public DataSource dataSource() throws NamingException {
		return (DataSource) new JndiTemplate()
			.lookup("java:comp/env/jdbc/AdventureWorks");
	}
